...
${input_mail}                   cz.alza.eshop:id/login_ffv
${input_psswd}                  cz.alza.eshop:id/password_ffv
...
#Search
${search_field}                 cz.alza.eshop:id/search_et
${search_input_text}            cz.alza.eshop:id/search_et
